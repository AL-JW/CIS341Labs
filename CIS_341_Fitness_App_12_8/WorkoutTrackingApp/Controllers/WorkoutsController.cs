        ...
        public IActionResult Index()
        {
            ...
            var workouts = _context.Workouts
                                   ...
                                   .Select(w => new WorkoutViewModel
                                   {
                                       ...
                                       CanEdit = w.UserId == currentUserId,
                                       //Description = w.Description, // Assuming you have this field in your Workout entity
                                       // Difficulty = "Some difficulty level", // You need to define how to get this
                                       SelectedExercises = w.WorkoutExercises.Select(we => we.ExerciseId).ToList(),
                                        ...
                                        {
                                            // Populate your ExerciseViewModel properties
